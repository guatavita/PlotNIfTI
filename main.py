...
def main():
    image_path = r"C:\Data\Data_test\plot_cervix\image.nii.gz"
    segmentation_paths = [r"C:\Data\Data_test\plot_cervix\CTVT.nii.gz",
                          r"C:\Data\Data_test\plot_cervix\Bladder.nii.gz",
                          r"C:\Data\Data_test\plot_cervix\Rectum.nii.gz",
                          r"C:\Data\Data_test\plot_cervix\BowelBag.nii.gz"]
